...
const Camera = ({ func, isSubmit, progress, submitfunc, isClear }: ICamera) => {
    ...
    return (
        <>
            ...
            {isClear && (
                <div className=" fixed bottom-8 p-4 rounded-2xl bg-green-200 text-green-800 shadow cursor-pointer fade-left transition-all duration-500 hover:scale-95 active:scale-90 "
                    onClick={() => handleReload()}>
                    <p>
                        <span>Data berhasil disubmit</span>
